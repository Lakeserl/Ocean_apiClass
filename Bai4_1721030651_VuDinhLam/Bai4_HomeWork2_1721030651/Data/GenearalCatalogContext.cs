...
namespace Bai4_HomeWork2_1721030651.Data;

public partial class GenearalCatalogContext : DbContext
{
    public GenearalCatalogContext()
    {
    }

    public GenearalCatalogContext(DbContextOptions<GenearalCatalogContext> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=Lakeserl; Initial Catalog=GenearalCatalog; Persist Security Info=True; User ID=sa; Password=123456; Trust Server Certificate=True;");
